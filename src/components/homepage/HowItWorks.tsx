    ...
    <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-linear-to-r from-accent/10 to-[#00A89A]/10 border border-accent/20 text-accent rounded-2xl text-sm mb-6 font-bold shadow-sm">
            ...
            <div key={index} className="relative group">
              <div className="text-center space-y-6">
                <div className="relative inline-block">
                  <div className="w-24 h-24 bg-primary-gradient rounded-3xl flex items-center justify-center mx-auto shadow-2xl shadow-primary/30 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="mt-20 text-center">
          <div className="inline-flex flex-col items-center gap-4 px-8 py-6 bg-surface border-2 border-border rounded-3xl shadow-lg hover:shadow-xl transition-all">
            ...
            <button
              ...
              className="px-8 py-3 bg-primary-gradient text-primary-foreground hite rounded-2xl hover:shadow-xl hover:shadow-red-900/30 transition-all transform hover:-translate-y-1 font-bold"
            >
