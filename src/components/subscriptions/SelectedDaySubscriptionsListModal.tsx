...
export default function SelectedDaySubscriptionsListModal({selectedSubsciptionsByDay, closeSubscriptionModals, setSelectSubscriptionDetails, selectedDay}:SelectedDaySubscriptionsListModalProps) {
        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    >
                        <motion.button
                            onClick={()=> closeSubscriptionModals(SubscriptionModalTypes.LIST)}
                        ...
                        >
                            {
                                ...
                                (selectedSubsciptionsByDay.map((subscription, index)=>(
                                    ...
                                    >
                                        <img src={subscription.details.iconUrl} className="w-8 h-8 rounded-md"/>
                                        <p className="text-white text-xl font-bold">{subscription.details.name}</p>
                                        <span className="text-[#848484] text-xl font-bold">${subscription.price}</span>
                                    </motion.div>
                                )))
                            }
                            ...
                            >
                                {selectedDay && formatToReadableDate(new Date(selectedDay).toDateString())}
                            </motion.div>
                        </motion.div>
                    </motion.div>
                </motion.div>
